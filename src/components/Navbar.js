    ...
    return (
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1 float-animation">
                    <Link 
                        to="home"
                        smooth={true}
                        duration={500}
                            ...
                            <div className="space--2 py-6">
                                {navigation.map((item) => (
                                    <Link
                                        ...
                                        smooth={true}
                                        duration={500}
                                        className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-indigo-700"
                                    >
                                        {item.name}
                                    </Link>
                                ))}
